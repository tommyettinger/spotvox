...
@CommandLine.Command(name = "spotvox", version = "SpotVox 0.0.9",
...
public class HeadlessLauncher implements Callable<Integer> {
	...
	@CommandLine.Option(names = {"-e", "--edge"}, description = "How to shade the edges of voxels next to gaps or the background; one of: none, partial, light, heavy, block, wire.", defaultValue = "light")
